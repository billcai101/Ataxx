 ...
 *
 *
 * I also added some of my own tests here.
 *  @author Bill Cai
 *
 */
public class PathTest {
    ...
    /** Edges for test graph 3 (I added). */
    private static final Object[][] E3 = {
            { 1, 2, 2.0 },
            { 1, 3, 3.0 },
            { 1, 4, 4.0 },
            { 2, 4, 3.0 },
    ...
    /** Edges for test graph 4 (I added). */
    private static final Object[][] E4 = {
            { 1, 2, 8.0 },
            { 1, 3, 2.0 },
            { 1, 4, 5.0 },
            { 2, 4, 2.0 },
    ...
    /** Edges for test graph 5 (I added). */
    private static final Object[][] E5 = {
            { 1, 2, 1.0 },
            { 1, 3, 4.0 },
            { 2, 3, 2.0 },
            { 2, 4, 5.0 },
    ...
    /** Edges for test graph 6 (I added). */
    private static final Object[][] E6 = {
            { 1, 2, 1.0 },
            { 1, 4, 2.0 },
            { 4, 5, 3.0 },
            { 5, 7, 3.0 },
    ...
    /** Number of vertices in graph 3. */
    private static final int NV3 = 5;

    /** Number of vertices in graph 4. */
    private static final int NV4 = 8;

    /** Number of vertices in graph 5. */
    private static final int NV5 = 5;

    /** Number of vertices in graph 6. */
    private static final int NV6 = 7;

    /** Result of the path of shortestpath for graph 4. */
    private static final Integer[] P3_3 = { 1, 4};

    /** Result of the path of shortestpath for graph 4. */
    private static final Integer[] P4_4 = {1, 3, 4, 5, 7, 6};

    /** Direct distances for graph 5. */
    private static final double[] H5 = { INF, 7.0, 6.0, 4.0, 2.0, 0.0 };

    /** Path for graph 5. */
    private static final Integer[] P5_5 = { 1, 2, 3, 4, 5 };

    /** Direct distances for graph 6. */
    private static final double[] H6 = {INF, 8.0, 6.0, 5.0, 6.0, 3.0, 1.0, 0.0};

    /** Path for graph 6. */
    private static final Integer[] P6_6 = { 1, 4, 5, 7 };

    /** Test Shortestpath on a simple graph. */
    @Test(timeout = 1000)
    public void shortestpath() {
        fillWeightedGraph(new DG(), NV3, E3);
        ShortestPaths sp = new SP1(1);
        sp.setPaths();
        assertEquals("wrong path", asList(P3_3), sp.pathTo(4));
    ...
    public void shortestpath2() {
        fillWeightedGraph(new UG(), NV4, E4);
        ShortestPaths sp = new SP1(1);
        sp.setPaths();
        assertEquals("wrong path", asList(P4_4), sp.pathTo(6));
    }

    /** Test A* on a simple graph. */
    @Test(timeout = 1000)
    public void shortestpathastar() {
        fillWeightedGraph(new DG(), NV5, E5);
        ShortestPaths sp = new SP2(1, 5, H5);
        sp.setPaths();
        assertEquals("wrong path", asList(P5_5), sp.pathTo(5));
    }

    /** Test A* on another simple graph. */
    @Test(timeout = 1000)
    public void shortestpathastar2() {
        fillWeightedGraph(new DG(), NV6, E6);
        ShortestPaths sp = new SP2(1, 7, H6);
        sp.setPaths();
        assertEquals("wrong path", asList(P6_6), sp.pathTo(7));
    }
